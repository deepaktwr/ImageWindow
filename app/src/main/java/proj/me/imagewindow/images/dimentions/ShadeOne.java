...
public class ShadeOne {
    public static BeanShade1 calculateDimentions(int width, int height){
        ...
        float WIDTH_1 = Utils.HAS_FIXED_DIMENSIONS ? Utils.MAX_WIDTH : width > Utils.MAX_WIDTH ? Utils.MAX_WIDTH : width < Utils.MIN_WIDTH ? Utils.MIN_WIDTH : width;
        float HEIGHT_1 = Utils.HAS_FIXED_DIMENSIONS ? Utils.MAX_HEIGHT : height > Utils.MAX_HEIGHT ? Utils.MAX_HEIGHT : height < Utils.MIN_HIGHT ? Utils.MIN_HIGHT : height;
